...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Delius+Unicase&family=Rancho&family=Qwigley&family=Poppins:wght@100;300;400;500;600;700;800&family=Montserrat:wght@400;800&display=swap"
        rel="stylesheet">
...
@endif
    ...
    <nav
        class="absolute top-0 w-full h-20 flex items-center justify-between px-10 z-50 animate-slide-down hover:bg-white/90 hover:text-[#503c32] transition-colors duration-300">
    ...
    {{-- register --}}
    <div class="bg-white rounded-[10px] shadow-2xl relative overflow-hidden w-[768px] max-w-full min-h-[480px] container"
        id="container">
        <div
            class="absolute top-0 left-0 w-1/2 h-full transition-all duration-600 ease-in-out opacity-0 z-[1] form-container sign-up-container bg-white">
        ...
        <div
            class="absolute top-0 left-0 w-1/2 h-full transition-all duration-600 ease-in-out z-[2] form-container sign-in-container bg-white">
            <form action="{{route('postlogin')}}" method="POST"
                ...
                <button type="submit"
                    class="rounded-[20px] border border-choco-border bg-choco-btn text-[#432900] text-xs font-bold uppercase py-3 px-10 mt-2 tracking-wider transition-transform active:scale-95 focus:outline-none hover:bg-[#e0cba0]">
                    Login
                </button>
            </form>
        </div>
        ...
        <div
            class="absolute top-0 left-1/2 w-1/2 h-full overflow-hidden transition-transform duration-600 ease-in-out z-[100] overlay-container">
            <div
                class="bg-no-repeat bg-cover bg-[0_0] text-choco-accent relative -left-full h-full w-[200%] transform translate-x-0 transition-transform duration-600 ease-in-out overlay flex">

                <div class="overlay-panel overlay-left absolute flex flex-col items-center justify-center px-10 text-center top-0 h-full w-1/2 transform -translate-x-[20%] transition-transform duration-600 ease-in-out bg-cover bg-center"
                    style="background-image: url('../../img/login/login3.jpg');">

                    <h1 class="font-bold text-3xl mb-0 text-white drop-shadow-lg">Welcome ChocoScript</h1>
                    <p class="text-sm font-light leading-5 my-5 text-gray-100 drop-shadow-md">To keep connected with us
                        please login with your personal info</p>

                    <button
                        class="ghost rounded-full border-2 border-white bg-white/10 text-white text-sm font-bold uppercase py-3 px-12 tracking-widest transition-all duration-300 backdrop-blur-md shadow-lg hover:bg-white hover:text-[#432900] hover:scale-105 hover:shadow-[0_0_20px_rgba(255,255,255,0.4)] active:scale-95 focus:outline-none"
                        id="signIn">
                        Login
                    </button>
                ...
                <div class="overlay-panel overlay-right absolute right-0 flex flex-col items-center justify-center px-10 text-center top-0 h-full w-1/2 transform translate-x-0 transition-transform duration-600 ease-in-out bg-cover bg-center"
                    style="background-image: url('../../img/login/login.png');">

                    <h1 class="font-bold text-3xl mb-0 text-white drop-shadow-lg">Hello, Friend!</h1>
                    <p class="text-sm font-light leading-5 my-5 text-gray-100 drop-shadow-md">Enter your personal
